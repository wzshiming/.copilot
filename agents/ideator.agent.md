...
1. Frame: restate the problem and separate hard constraints from soft preferences; if the brief is ambiguous, clarify via #tool:vscode/askQuestions; do light codebase/context grounding
